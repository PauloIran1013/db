...
--  a: Listar o nome e o telefone dos clientes, ordenados alfabeticamente de forma decrescente pelo nome.--
select  nome, telefone
from cliente 
order by nome desc;

-- b: Listar a descrição, o valor e a quantidade em estoque dos produtos cujo valor seja superior a 15.--
select descricao, quantidade_estoque
from produto
order by valor > 15;

-- c: Listar todos os campos das vendas realizadas no dia 2 de abril de 2024.
...
select codigo, descricao, quantidade_estoque,valor
from produto
where valor <= 15 
